...
class Database(object):
    ...
    def list_tasks(self, taskid=None, limit=None, details=False, category=None,
                   ...
                   completed_after=None, order_by=None, user_id=None, user_status=None, not_this_user=None, this_user=None, this_user_union_public=None):
	    ...
	    if this_user:
                search = search.filter(Task.user_id==this_user,Task.user_status==1)
            if this_user_union_public:
		search = search.filter(((Task.user_id==this_user) & (Task.user_status==1)) | (Task.user_status==0))
